...
describe('String Sum code kata', () => {
  ...
  test('should return 0 when num1 is 7 and num2 is 8', () => {
    //ARRANGE
    const num1='8';
    const num2='7';
    const result=15;
  ...
  test('should return 50 when num 1 is empty string and num2 is 50', () => {
    //ARRANGE
    const num1='';
    const num2='50';
    const result=50;
  ...
  test('should return 30 when num 1 is 30  and num2 is not natural', () => {
    //ARRANGE
    const num1='30';
    const num2='-50';
    const result=30;
